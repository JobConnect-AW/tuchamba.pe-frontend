    ...
    <div class="flex flex-col md:flex-row gap-6 w-full flex-[100%]">
      ...
      <fieldset class="border border-dashed border-blue-400 rounded p-4 md:flex-1 flex flex-col gap-2">
        ...
        <div class="flex flex-col mb-4">
          ...
          <Dropdown id="technicalCategory" v-model="form.technicalCategory" :options="technicalCategories"
            optionLabel="label" optionValue="value" placeholder="Seleccionar Trabajo*" />
        </div>
      ...
      <fieldset class="border border-dashed border-blue-400 rounded p-4 md:flex-1 flex flex-col gap-2">
        ...
        <div class="flex flex-col mb-4">
          <label for="requiredExperience" class="mb-1 font-medium">Experiencia Mínima Requerida</label>
          <Dropdown id="requiredExperience" v-model="form.requiredExperience" :options="experiences" optionLabel="label"
            optionValue="value" placeholder="Seleccionar Experiencia*" />
        </div>

        <div class="flex flex-col">
          <label for="workSchedule" class="mb-1 font-medium">Horario de Trabajo</label>
          <Dropdown id="workSchedule" v-model="form.workSchedule" :options="workSchedules" optionLabel="label"
            optionValue="value" placeholder="Elige Rango de Horas*" />
        </div>
      </fieldset>
    </div>
    <div class="flex flex-col md:flex-row gap-6 w-full flex-[100%]">
      <fieldset class="border border-dashed border-blue-400 rounded p-4  md:flex-1 flex flex-col gap-2">
        ...
        <div class="flex flex-col">
          ...
          <Dropdown id="paymentMethod" v-model="form.paymentMethod" :options="paymentMethods" optionLabel="label"
            optionValue="value" placeholder="Seleccionar Forma de Pago*" />
        </div>
      </fieldset>
      ...
      <fieldset class="rounded p-4 flex flex-col gap-4  md:flex-1">
        ...
        <div class="flex items-start gap-4 mt-2">
          <Checkbox binary inputId="notificationsAccepted" v-model="form.notificationsAccepted" class="mr-2" />
          <label for="notificationsAccepted" class="select-none">Acepto recibir notificaciones sobre el estado de esta
            oferta</label>
        </div>
        ...
        <Button type="submit" :disabled="!form.personalDataConsent"
